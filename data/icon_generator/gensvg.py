...
# First is the name of the icon; second the inner color for the arrow; third the outline color for the arrow; fourth the fill color for the container circle

colors={"white":["#bebebe","#234567","#ffffff"],
	"red":["#ff0000","#ff0000","#ffffff"],
	"green":["#00ff00","#00ff00","#ffffff"],
	"yellow":["#ffc000","#ffc000","#ffffff"],
	"orange":["#ff8000","#ff8000","#ffffff"],
	"cyan": ["#00ffff","#00ffff","#ffffff"]}

# DEFAULT_SIZE contains the outline width for the arrow
default_size=18
